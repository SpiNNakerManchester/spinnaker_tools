...
int fp_recip(int a)
{
    // This is the optimal starting estimate for the reciprocal of values
    // known to be in the range 0.5 to 1.0
...
// given a collision point, a surface normal, and the direction of the inward
